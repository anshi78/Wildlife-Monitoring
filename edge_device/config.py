...
API_URL = "https://wildlife-monitoring.onrender.com"
...
DB_FILE = os.path.join(BASE_DIR, "local_detections.db")
IMG_DIR = os.path.join(BASE_DIR, "detected_images")

# --- Model & Detection Configuration ---
# IMPORTANT: Change this to point to your custom-trained .pt file
MODEL_PATH = os.path.join(BASE_DIR, "../runs/detect/wildlife_custom_model/weights/last.pt")
